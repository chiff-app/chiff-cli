...
seed = test_helper.create_seed()


# def test_generate_password_should_return_password():
#     ppd = test_helper.sample_ppd(8, 32)
#     password_generator_instance = password_generator.PasswordGenerator("test", test_helper.linked_in_ppd_handle, seed,
#                                                                        ppd)
...
def test_calculate_password_offset_should_result_in_same_password():
    ...
    password_generator_instance = password_generator.PasswordGenerator("test", site["id"], seed, site["ppd"])
